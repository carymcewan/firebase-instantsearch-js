...
var _ref = _preactCompat2.default.createElement('symbol', {
...
var _ref2 = _preactCompat2.default.createElement('symbol', {
  xmlns: 'http://www.w3.org/2000/svg',
  id: 'sbx-icon-clear-2',
  viewBox: '0 0 20 20'
}, _preactCompat2.default.createElement('path', {
...
var _ref3 = _preactCompat2.default.createElement('button', {
  type: 'submit',
  title: 'Submit your search query.',
  className: 'sbx-sffv__submit'
}, _preactCompat2.default.createElement('svg', { role: 'img', 'aria-label': 'Search' }, _preactCompat2.default.createElement('use', { xlinkHref: '#sbx-icon-search-12' })));

var _ref4 = _preactCompat2.default.createElement('button', {
  type: 'reset',
  title: 'Clear the search query.',
  className: 'sbx-sffv__reset'
}, _preactCompat2.default.createElement('svg', { role: 'img', 'aria-label': 'Reset' }, _preactCompat2.default.createElement('use', { xlinkHref: '#sbx-icon-clear-2' })));
...
var SearchBox = function (_Component) {
  ...
  _createClass(SearchBox, [{
    ...
    value: function render() {
      ...
      return _preactCompat2.default.createElement('form', {
      ...
      }, _preactCompat2.default.createElement('svg', { xmlns: 'http://www.w3.org/2000/svg', style: { display: 'none' } }, _ref, _ref2), _preactCompat2.default.createElement('div', { role: 'search', className: 'sbx-sffv__wrapper' }, _preactCompat2.default.createElement('input', {
        type: 'search',
        name: 'search',
