...
var RefinementListItem = function (_Component) {
  ...
  _createClass(RefinementListItem, [{
    ...
    value: function render() {
      return _preactCompat2.default.createElement('div', { className: this.props.itemClassName, onClick: this.handleClick }, _preactCompat2.default.createElement(_Template2.default, _extends({
