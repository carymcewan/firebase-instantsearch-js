    ...
    _createClass(AutoHide, [{
      ...
      value: function render() {
        ...
        return _preactCompat2.default.createElement(
          ...
          _preactCompat2.default.createElement(ComposedComponent, this.props)
        );
      }
    }]);

    return AutoHide;
  }(_preactCompat.Component), _class.displayName = ComposedComponent.name + '-AutoHide', _class.propTypes = { shouldAutoHideContainer: _propTypes2.default.bool.isRequired }, _temp;
};
