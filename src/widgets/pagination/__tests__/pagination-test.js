...
describe('pagination()', function () {
  ...
  beforeEach(function () {
    ...
    _pagination2.default.__Rewire__('render', ReactDOM.render);
  ...
  describe('mocking getContainerNode', function () {
    ...
    it('should scroll to body', function () {
      ...
      widget.init({ helper: helper });
      widget.render({ results: results, helper: helper, state: { page: 0 } });
      var setCurrentPage = ReactDOM.render.firstCall.args[0].props.setCurrentPage;
  ...
  afterEach(function () {
    _pagination2.default.__ResetDependency__('render');
