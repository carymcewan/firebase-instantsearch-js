...
describe('generateRanges()', function () {
  it('should generate ranges', function () {
    ...
    expect((0, _generateRanges2.default)(stats)).toEqual(expected);
  });
  ...
  it('should not generate ranges', function () {
    ...
    expect((0, _generateRanges2.default)(stats)).toEqual([]);

    var longerStats = { min: 6765, max: 6765, avg: 6765, sum: 6765 };
    expect((0, _generateRanges2.default)(longerStats)).toEqual([]);
  });
});