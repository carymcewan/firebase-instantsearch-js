...
RefinementListItem.propTypes = {
  facetValueToRefine: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
  handleClick: _propTypes2.default.func.isRequired,
  isRefined: _propTypes2.default.bool.isRequired,
  itemClassName: _propTypes2.default.string,
  subItems: _propTypes2.default.object,
  templateData: _propTypes2.default.object.isRequired,
  templateKey: _propTypes2.default.string.isRequired,
