...
PriceRangesForm.propTypes = {
  ...
  currentRefinement: _propTypes2.default.shape({
    from: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
    to: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number])
  }),
