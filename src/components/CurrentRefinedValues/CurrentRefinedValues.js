...
RawCurrentRefinedValues.propTypes = {
  ...
  clearAllClick: _propTypes2.default.func,
  clearAllPosition: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool]),
  clearAllURL: _propTypes2.default.string,
  clearRefinementClicks: _propTypes2.default.arrayOf(_propTypes2.default.func),
  clearRefinementURLs: _propTypes2.default.arrayOf(_propTypes2.default.string),
  ...
  refinements: _propTypes2.default.array,
