...
var PriceRangesForm = function (_Component) {
  ...
  _createClass(PriceRangesForm, [{
    ...
    value: function getInput(type) {
      ...
      return _preactCompat2.default.createElement('label', { className: this.props.cssClasses.label }, _preactCompat2.default.createElement('span', { className: this.props.cssClasses.currency }, this.props.labels.currency, ' '), _preactCompat2.default.createElement('input', {
    ...
    value: function render() {
      ...
      }, fromInput, _preactCompat2.default.createElement('span', { className: this.props.cssClasses.separator }, ' ', this.props.labels.separator, ' '), toInput, _preactCompat2.default.createElement('button', { className: this.props.cssClasses.button, type: 'submit' }, this.props.labels.button));
    }
  }]);
