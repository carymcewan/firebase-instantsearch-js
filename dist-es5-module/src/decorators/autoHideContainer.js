  ...
  return _temp = _class = function (_Component) {
    ...
    _createClass(AutoHide, [{
      ...
      value: function render() {
        ...
        return _preactCompat2.default.createElement('div', { style: { display: shouldAutoHideContainer ? 'none' : '' } }, _preactCompat2.default.createElement(ComposedComponent, this.props));
      }
    }]);

    return AutoHide;
  }(_preactCompat.Component), _class.displayName = ComposedComponent.name + '-AutoHide', _temp;
};
