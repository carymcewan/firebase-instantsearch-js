...
var createInfoBox = function createInfoBox(googleReference) {
  ...
  */
  function InfoBox(opt_opts) {
    ...
    googleReference.maps.OverlayView.apply(this, arguments);
  ...
  */
  InfoBox.prototype.panBox_ = function (disablePan) {
    ...
    if (!disablePan) {
      ...
      if (map instanceof googleReference.maps.Map) {
  ...
  InfoBox.prototype.close = function () {
    ...
    if (this.eventListeners_) {
      for (i = 0; i < this.eventListeners_.length; i++) {
        googleReference.maps.event.removeListener(this.eventListeners_[i]);
      }
      this.eventListeners_ = null;
    }

    if (this.moveListener_) {
      googleReference.maps.event.removeListener(this.moveListener_);
      this.moveListener_ = null;
    }

    if (this.mapListener_) {
      googleReference.maps.event.removeListener(this.mapListener_);
      this.mapListener_ = null;
    }

    if (this.contextListener_) {
      googleReference.maps.event.removeListener(this.contextListener_);
      this.contextListener_ = null;
    }
